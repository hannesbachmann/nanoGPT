...
class MultiheadLatentAttention(nn.Module):
    ...
    use Causal self-attention after down-up scaling of the q,k,v values
    with RoPE as positional embedding"""
...
def apply_rope(x, inv_freq):
    ...
    x1 = x[..., ::2]
    x2 = x[..., 1::2]
    x_rotated = torch.stack([x1, x2], dim=-1)
...
class BlockMLA(nn.Module):
    """transformer block containing multi-head latent attention"""
